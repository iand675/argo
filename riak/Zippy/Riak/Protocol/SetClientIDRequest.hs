...
module Zippy.Riak.Protocol.SetClientIDRequest (SetClientIDRequest(..)) where
import Prelude ((+), (/))
...
data SetClientIDRequest = SetClientIDRequest{clientId :: !P'.ByteString}
